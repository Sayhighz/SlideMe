...
export default function HomeScreen() {
  ...
  return (
    <View style={tw`flex-1 bg-white items-center p-4`}>
      ...
      <View style={tw`flex-1 flex-row justify-around w-full mt-6 p-4 bg-gray-100 rounded-lg`}>
      ...
      <View style={tw`flex-1 w-full h-60 bg-gray-200 mt-6 rounded-lg items-center justify-center`}>
      ...
      <TouchableOpacity 
        style={tw`w-11/12 bg-green-500 rounded-full p-6 mt-6 items-center`}
